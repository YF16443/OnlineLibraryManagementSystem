<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/LibrarianPages/MasterPage.master" AutoEventWireup="true" CodeFile="IssueReport.aspx.cs" Inherits="Pages_LibrarianPages_IssueReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="header" Runat="Server">
    ...
    <a> <asp:Label runat="server" Text="<%$ Resources:Resource, IssueReport %>" CssClass="navbar-brand"></asp:Label> </a>
</asp:Content>
    ...
    <div class="card">
        <div class="content">
            ...
            <div class="material-datatables">
                <asp:GridView ID="Issue" runat="server" CssClass="table table-striped table-no-bordered table-hover" AutoGenerateColumns="False" style="width:100%;cellspacing:0">
                    <Columns>
                        <asp:BoundField HeaderText="<%$ Resources:Resource, ReaderId %>" DataField="ReaderId" ReadOnly="true" />
                        <asp:BoundField HeaderText="<%$ Resources:Resource, Barcode %>" DataField="Barcode" ReadOnly="true" />
...
<asp:Content ID="content4" ContentPlaceHolderID="foot" runat="server">
    ...
    <script>
        var income = $124('#body_Issue').DataTable({
            "searching": false,
            "lengthChange": false,
            "order": [[3, 'asc']],
        });
