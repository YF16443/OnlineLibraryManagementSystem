...
public partial class Pages_LibrarianPages_ForgotPassword : BasePage
{
    ...
    {
        if (!rfvAccount.IsValid || !rfvName.IsValid)
        {
            return;
        }
        ...
        cmd.CommandText = "select * from Librarians where Account=" + account;
