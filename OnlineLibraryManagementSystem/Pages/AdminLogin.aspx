        ...
        <div class="header text-center">
            ...
            <tr>
                ...
                <td style="text-align:center; width:300px">
                    <asp:Login ID="Login1" runat="server" LoginButtonText="<%$ Resources:Resource,Login_Login %>" PasswordLabelText="<%$ Resources:Resource,Login_Password %>" RememberMeText="<%$ Resources:Resource,Login_Remember %>" TitleText="<%$ Resources:Resource,AdminLogin %>" UserNameLabelText="<%$ Resources:Resource,Login_UsrName %>" Width="300px" DestinationPageUrl="~/Pages/AdminPages/Settings.aspx" OnAuthenticate="Login1_Authenticate" CssClass="content" EnableTheming="True" PasswordRequiredErrorMessage="*" style="left: 0px; top: 0px" UserNameRequiredErrorMessage="*" FailureText="<%$ Resources:Resource,LoginFailure %>">
