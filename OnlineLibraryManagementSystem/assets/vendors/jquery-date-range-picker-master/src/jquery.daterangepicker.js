    ...
    $.dateRangePickerLanguages =
        {
            'az':
            {
                ...
                'week-6': '6',
                'week-7': '7',
                'month-name': ['Yanvar', 'Fevral', 'Mart', 'Aprel', 'May', '陌yun', '陌yul', 'Avqust', 'Sentyabr', 'Oktyabr', 'Noyabr', 'Dekabr'],
                'shortcuts': 'Q谋sayollar',
                'past': 'Ke莽mi艧',
                'following': 'N枚vb蓹ti',
                'previous': '&nbsp;&nbsp;&nbsp;',
                'prev-week': '脰nc蓹ki h蓹ft蓹',
                'prev-month': '脰nc蓹ki ay',
                'prev-year': '脰nc蓹ki il',
                'next': '&nbsp;&nbsp;&nbsp;',
                'next-week': 'N枚vb蓹ti h蓹ft蓹',
                'next-month': 'N枚vb蓹ti ay',
                'next-year': 'N枚vb蓹ti il',
                'less-than': 'Tarix aral谋臒谋 %d g眉nd蓹n 莽ox olmamal谋d谋r',
                'more-than': 'Tarix aral谋臒谋 %d g眉nd蓹n az olmamal谋d谋r',
                'default-more': '%d g眉nd蓹n 莽ox bir tarix se莽in',
                'default-single': 'Tarix se莽in',
                'default-less': '%d g眉nd蓹n az bir tarix se莽in',
                'default-range': '%d v蓹 %d g眉n aral谋臒谋nda tarixl蓹r se莽in',
                'default-default': 'Tarix aral谋臒谋 se莽in'
            },
            'cn':
            {
                'selected': '宸查€夋嫨:',
                ...
                'week-6': '鍏�',
                'week-7': '鏃�',
                'month-name': ['涓€鏈�', '浜屾湀', '涓夋湀', '鍥涙湀', '浜旀湀', '鍏湀', '涓冩湀', '鍏湀', '涔濇湀', '鍗佹湀', '鍗佷竴鏈�', '鍗佷簩鏈�'],
                'shortcuts': '蹇嵎閫夋嫨',
                'past': '杩囧幓',
                'following': '灏嗘潵',
                'previous': '&nbsp;&nbsp;&nbsp;',
                ...
                'next-month': '涓嬩釜鏈�',
                'next-year': '鏄庡勾',
                'less-than': '鎵€閫夋棩鏈熻寖鍥翠笉鑳藉ぇ浜�%d澶�',
                'more-than': '鎵€閫夋棩鏈熻寖鍥翠笉鑳藉皬浜�%d澶�',
                'default-more': '璇烽€夋嫨澶т簬%d澶╃殑鏃ユ湡鑼冨洿',
                'default-less': '璇烽€夋嫨灏忎簬%d澶╃殑鏃ユ湡鑼冨洿',
                'default-range': '璇烽€夋嫨%d澶╁埌%d澶╃殑鏃ユ湡鑼冨洿',
                'default-single': '璇烽€夋嫨涓€涓棩鏈�',
                'default-default': '璇烽€夋嫨涓€涓棩鏈熻寖鍥�'
            },
            'cz':
            {
                'selected': 'Vybr谩no:',
                ...
                'week-6': 'So',
                'week-7': 'Ne',
                'month-name': ['Leden', '脷nor', 'B艡ezen', 'Duben', 'Kv臎ten', '膶erven', '膶ervenec', 'Srpen', 'Z谩艡铆', '艠铆jen', 'Listopad', 'Prosinec'],
                'shortcuts': 'Zkratky',
                'past': 'po',
                'following': 'n谩sleduj铆c铆',
                'previous': 'p艡edchoz铆',
                'prev-week': 't媒den',
                'prev-month': 'm臎s铆c',
                'prev-year': 'rok',
                ...
                'next-month': 'm臎s铆c',
                'next-year': 'rok',
                'less-than': 'Rozsah data by nem臎l b媒t v臎t拧铆 ne啪 %d dn暖',
                'more-than': 'Rozsah data by nem臎l b媒t men拧铆 ne啪 %d dn暖',
                'default-more': 'Pros铆m zvolte rozsah data v臎t拧铆 ne啪 %d dn暖',
                'default-single': 'Pros铆m zvolte datum',
                'default-less': 'Pros铆m zvolte rozsah data men拧铆 ne啪 %d dn暖',
                'default-range': 'Pros铆m zvolte rozsah data mezi %d a %d dny',
                'default-default': 'Pros铆m zvolte rozsah data'
            },
            'en':
            {
                'selected': 'Selected:',
            ...
            'de':
            {
                ...
                'week-6': 'SA',
                'week-7': 'SO',
                'month-name': ['JANUAR', 'FEBRUAR', 'M脛RZ', 'APRIL', 'MAI', 'JUNI', 'JULI', 'AUGUST', 'SEPTEMBER', 'OKTOBER', 'NOVEMBER', 'DEZEMBER'],
                ...
                'next-month': 'Monat',
                'next-year': 'Jahr',
                'less-than': 'Datumsbereich darf nicht gr枚脽er sein als %d Tage',
                'more-than': 'Datumsbereich darf nicht kleiner sein als %d Tage',
                'default-more': 'Bitte mindestens %d Tage ausw盲hlen',
                'default-single': 'Bitte ein Datum ausw盲hlen',
                'default-less': 'Bitte weniger als %d Tage ausw盲hlen',
                'default-range': 'Bitte einen Datumsbereich zwischen %d und %d Tagen ausw盲hlen',
                'default-default': 'Bitte ein Start- und Enddatum ausw盲hlen'
            },
            'ru':
            {
                'selected': '袙褘斜褉邪薪芯:',
                ...
                'week-6': '小袘',
                'week-7': '袙小',
                'month-name': ['携袧袙袗袪鞋', '肖袝袙袪袗袥鞋', '袦袗袪孝', '袗袩袪袝袥鞋', '袦袗袡', '袠挟袧鞋', '袠挟袥鞋', '袗袙袚校小孝', '小袝袧孝携袘袪鞋', '袨袣孝携袘袪鞋', '袧袨携袘袪鞋', '袛袝袣袗袘袪鞋'],
                'shortcuts': '袘褘褋褌褉褘泄 胁褘斜芯褉',
                'past': '袩褉芯褕械写褕懈械',
                'following': '小谢械写褍褞褖懈械',
                'previous': '&nbsp;&nbsp;&nbsp;',
                'prev-week': '袧械写械谢褟',
                ...
                'next-month': '袦械褋褟褑',
                'next-year': '袚芯写',
                'less-than': '袛懈邪锌邪蟹芯薪 薪械 屑芯卸械褌 斜褘褌褜 斜芯谢褜褕械 %d 写薪械泄',
                'more-than': '袛懈邪锌邪蟹芯薪 薪械 屑芯卸械褌 斜褘褌褜 屑械薪褜褕械 %d 写薪械泄',
                'default-more': '袩芯卸邪谢褍泄褋褌邪 胁褘斜械褉懈褌械 写懈邪锌邪蟹芯薪 斜芯谢褜褕械 %d 写薪械泄',
                'default-single': '袩芯卸邪谢褍泄褋褌邪 胁褘斜械褉懈褌械 写邪褌褍',
                'default-less': '袩芯卸邪谢褍泄褋褌邪 胁褘斜械褉懈褌械 写懈邪锌邪蟹芯薪 屑械薪褜褕械 %d 写薪械泄',
                'default-range': '袩芯卸邪谢褍泄褋褌邪 胁褘斜械褉懈褌械 写懈邪锌邪蟹芯薪 屑械卸写褍 %d 懈 %d 写薪褟屑懈',
                'default-default': '袩芯卸邪谢褍泄褋褌邪 胁褘斜械褉懈褌械 写懈邪锌邪蟹芯薪'
            },
            'fr':
            {
                'selected': 'S茅lection:',
                ...
                'week-6': 'SA',
                'week-7': 'DI',
                'month-name': ['JANVIER', 'F脡VRIER', 'MARS', 'AVRIL', 'MAI', 'JUIN', 'JUILLET', 'AO脹T', 'SEPTEMBRE', 'OCTOBRE', 'NOVEMBRE', 'D脡CEMBRE'],
                ...
                'next-month': 'Mois',
                'next-year': 'Ann茅e',
                'less-than': 'L\'intervalle ne doit pas 锚tre sup茅rieure 脿 %d jours',
                'more-than': 'L\'intervalle ne doit pas 锚tre inf茅rieure 脿 %d jours',
                'default-more': 'Merci de choisir une intervalle sup茅rieure 脿 %d jours',
                'default-single': 'Merci de choisir une date',
                'default-less': 'Merci de choisir une intervalle inf茅rieure %d jours',
